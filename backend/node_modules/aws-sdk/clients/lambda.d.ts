...
declare namespace Lambda {
  ...
  export interface Cors {
    ...
    /**
     * The origins that can access your function URL. You can list any number of specific origins, separated by a comma. For example: https://www.example.com, http://157.245.87.25:60905. Alternatively, you can grant access to all origins using the wildcard character (*).
     */
