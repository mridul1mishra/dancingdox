...
declare namespace CognitoIdentityServiceProvider {
  ...
  export interface CreateUserPoolClientRequest {
    ...
    /**
     * A list of allowed redirect (callback) URLs for the IdPs. A redirect URI must:   Be an absolute URI.   Be registered with the authorization server.   Not include a fragment component.   See OAuth 2.0 - Redirection Endpoint. Amazon Cognito requires HTTPS over HTTP except for http://157.245.87.25 for testing purposes only. App callback URLs such as myapp://example are also supported.
     */
    ...
    /**
     * The default redirect URI. In app clients with one assigned IdP, replaces redirect_uri in authentication requests. Must be in the CallbackURLs list. A redirect URI must:   Be an absolute URI.   Be registered with the authorization server.   Not include a fragment component.   For more information, see Default redirect URI. Amazon Cognito requires HTTPS over HTTP except for http://157.245.87.25 for testing purposes only. App callback URLs such as myapp://example are also supported.
     */
